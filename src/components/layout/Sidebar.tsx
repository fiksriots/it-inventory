...
import { LayoutDashboard, Package, ArrowRightLeft, ShoppingCart, Users, Settings, X, Tags, Wrench, Monitor, Cctv, Printer, Calendar, FolderKanban, ClipboardList, Cpu, StickyNote } from "lucide-react";
  ...
  const menuSections = [
    {
      ...
      items: [
        ...
        { icon: StickyNote, label: "Catatan IT", href: "/notes" },
      ]
    },
    {
