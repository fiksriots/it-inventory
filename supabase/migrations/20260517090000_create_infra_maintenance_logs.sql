-- Membuat tabel riwayat perawatan (maintenance logs) untuk infrastruktur/fasilitas fisik
...
DROP POLICY IF EXISTS "Allow public read access" ON public.infrastructure_maintenance_logs;
